# -*- coding: utf-8 -*-
#
# scapy Communication Library for Topology documentation build configuration file.
#
...
project = 'scapy Communication Library for Topology'
...
latex_documents = [
    (
        ...
        'scapy Communication Library for Topology Documentation',
